...
# from deep_drone.smallervggnet import SmallerVGGNet
from deep_drone.DroneNet import DroneNet
...
model = DroneNet.build(width=IMAGE_DIMS[0], height=IMAGE_DIMS[1], depth=IMAGE_DIMS[2], classes=2)
